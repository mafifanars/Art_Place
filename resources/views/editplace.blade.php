...
<div class="container">
    ...
    <div class="col-lg-8 align-items-center">
        <form method="post" action="{{ url('/place'. $place->id . '/' . $idplace) }}" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <button type="submit" class="badge rounded-pill bg-primary bi bi-plus-circle"> Tambah</button>
        </form>
    </div>
</div>
